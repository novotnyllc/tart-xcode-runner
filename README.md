...
Codex plugin for running commands, Xcode builds, and XCUITests in disposable
Tart VMs. The powered-off `tart-xcui-base` VM is the golden image;
...
See [`skills/tart-xcui-runner/SKILL.md`](skills/tart-xcui-runner/SKILL.md) for
